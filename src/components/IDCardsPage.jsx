...
const IDCardsPage = () => {
  usePageTitle("ID Cards & Custom Prints");
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <div className="relative h-64 md:h-80 w-full overflow-hidden">
        <img
          ...
          alt="ID Cards Printing"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white drop-shadow-lg">ID Cards & Custom Prints</h2>
        </div>
      </div>
          ...
          {designs.map((design) => (
            ...
            >
              ...
              <div className={`${design.color} h-56 flex items-center justify-center relative overflow-hidden bg-opacity-30 p-4`}>
                <DesignPreview type="id-cards" style={design.color} title={design.title} />
              </div>
